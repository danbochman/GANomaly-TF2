...
from defect_classifier.classifier_trainer import SSTrainer
...
flags.DEFINE_float("lr", 0.00002, "Learning rate for optimizers")
...
flags.DEFINE_string("logs_dir", './defect_classifier/FC', "relative dir path to save TB events and checkpoints")
...
flags.DEFINE_integer("validation_steps", 100, "Number of validation steps (batches from generator)")
...
def main(argv=None):
    ...
    trainer = SSTrainer(train_generator=train_img_gen,
    ...
    trainer.train(training_steps=FLAGS.training_steps,
