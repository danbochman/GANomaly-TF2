...
def train_image_generator(folder_path, batch_size=64, crop_size=256, ext="png", repeat=True):
...
def test_image_generator(folder_path, batch_size=64, crop_size=256, ext="png"):
